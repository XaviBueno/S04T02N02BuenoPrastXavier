 ...
 * 
 */
package cat.itacademy.barcelonactiva.BuenoPrast.Xavier.s04.t02.n02.controllers;
...
import cat.itacademy.barcelonactiva.BuenoPrast.Xavier.s04.t02.n02.model.services.FruitaService;
...
public class FruitaController {
	...
	public ResponseEntity<Fruita> add(@RequestBody  Fruita fruita) {
		...
		try {
			myFruita= fruitaServices.addFruita(fruita.getNom(), fruita.getQuantitatQuilos());
